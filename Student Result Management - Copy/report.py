...
class reportClass:
    def __init__(self, root):
        ...
        self.var_id=""
        lbl_Search=Label(self.root,text="Search By Roll No.",font=("goudy old style",17,'bold'),bg='white').place(x=280,y=100)
        lbl_Search=Entry(self.root,textvariable=self.var_search,font=("goudy old style",20),bg='lightyellow').place(x=520,y=100,width=150)
        btn_Search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="#03a9f4",activebackground="skyblue",cursor="hand2",command=self.search).place(x=680,y=100,width=100,height=35)
        btn_Clear=Button(self.root,text="Clear",font=("goudy old style",15,"bold"),bg="gray",activebackground="white",cursor="hand2",command=self.clear).place(x=800,y=100,width=100,height=35)
        ...
        #=============Delete Button===========
        btn_delete=Button(self.root,text="Delete",font=("goudy old style",15,"bold"),bg="Red",activebackground="white",cursor="hand2",command=self.delete).place(x=510,y=360,width=150,height=35)
    ...
    def delete(self):
        ...
        try:
            if self.var_id=="":
                messagebox.showerror("Error","Search Student Result Frist",parent=self.root)
            else:
