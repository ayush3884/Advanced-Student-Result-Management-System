...
class StudentClass:
    def __init__(self, root):
        ...
        self.txt_city.place(x=370, y=220, width=120)
        ...
        try:
            if self.var_roll.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Succss","Student Added Successfully",parent=self.root)
                    self.show()
        except Exception as ex:
             messagebox.showerror("Error",f"Error due to {str(ex)}")
        ...
        try:
            if self.var_roll.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Succss","Student Update Successfully",parent=self.root)
                    self.show()
        except Exception as ex:
             messagebox.showerror("Error",f"Error due to {str(ex)}")
