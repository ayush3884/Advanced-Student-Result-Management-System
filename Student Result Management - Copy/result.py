...
class resultClass:
    def __init__(self, root):
        ...
        btn_Search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="#03a9f4",activebackground="#03a9f4",cursor="hand2",command=self.search).place(x=500,y=100,width=100,height=28)
        #======Widgets=======
        ...
        btn_add.place(x=300,y=420,width=110,height="40")
        ...
        btn_clear.place(x=430,y=420,width=110,height="40")
        ...
        try:
            if self.var_name.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Succss","Result Added Successfully",parent=self.root)
        except Exception as ex:
             messagebox.showerror("Error",f"Error due to {str(ex)}")
